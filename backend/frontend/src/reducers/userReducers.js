...
export const createAddressesReducer = (state = {}, action) =>{
    switch (action.type) {
...
export const updateAddressesReducer = (state = {}, action) =>{
    switch (action.type) {
...
export const deleteAddressesReducer = (state = {}, action) =>{
    switch (action.type) {
